			...
			<div id="logo">
				...
				<?php if(!get_theme_mod('sp_logo')) : ?>
					...
					<?php if(is_front_page()) : ?>
						<h1><a href="<?php echo home_url(); ?>"><object id="svg1" data="<?php echo get_template_directory_uri(); ?>/img/logo.svg" type="image/svg+xml"></object> </a></h1>
					<?php else : ?>
						<h2><a href="<?php echo home_url(); ?>"><object id="svg1" data="<?php echo get_template_directory_uri(); ?>/img/logo.svg" type="image/svg+xml"></object></a></h2>
					<?php endif; ?>
